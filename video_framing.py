...
Original file is located at
    https://colab.research.google.com/drive/1Df4qYV1soSNceBeFme3PMTPbsCpEaVC9
"""
...
def extract_image_one_fps(video_source_path):
    ...
    while success:
      ...
      if real_count == 0:
        cv2.imwrite("/gdrive/My Drive/nomask.png",image)
      ...
      cv2.imwrite("/gdrive/My Drive/videoimage5/frame%d.png" % real_count, image)     # save frame as PNG file
